 ...
 */
final class Version20230915003106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lessons ADD masterclass_id INT NOT NULL');
        $this->addSql('ALTER TABLE lessons ADD CONSTRAINT FK_3F4218D9426F0705 FOREIGN KEY (masterclass_id) REFERENCES masterclass (id)');
        $this->addSql('CREATE INDEX IDX_3F4218D9426F0705 ON lessons (masterclass_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3F4218D9426F0705 ON lessons');
        $this->addSql('ALTER TABLE lessons DROP masterclass_id');
