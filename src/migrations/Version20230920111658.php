 ...
 */
final class Version20230920111658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, event_id INT DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_CBE5A33167B3B43D (users_id), INDEX IDX_CBE5A33171F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, number_like INT NOT NULL, name VARCHAR(255) NOT NULL, phone INT DEFAULT NULL, price INT DEFAULT NULL, address VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, event_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A33167B3B43D FOREIGN KEY (users_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A33171F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP FOREIGN KEY FK_CBE5A33171F7E88B');
